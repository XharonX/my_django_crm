...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        position, created = Position.objects.get_or_create(name='Manager')
        permission, created = Permission.objects.get_or_create(codename='can_view_sales_data')
        ...
        self.stdout.write(self.style.SUCCESS("Sales manager created SUCCESSFULLY."))
